...
SCHEMA = "k3-21tps-ordinary-prefix-canary-v2"
FIXTURE_SCHEMA = "k3-21tps-ordinary-prefix-fixture-v1"
...
def validate_fixture(tokenizer: Tokenizer, raw: object) -> dict[str, dict[str, object]]:
    ...
    required = {"decode_4294", "base_32768", "append_32769"}
...
def analyze_decode(rows: Sequence[dict[str, object]]) -> dict[str, object]:
    ...
    expected_labels = {*measured_labels, DECODE_PREFIX_SMOKE_LABEL}
    ...
    for label, row in by_label.items():
        ...
        expected_prefix_request = label == DECODE_PREFIX_SMOKE_LABEL
        if (
